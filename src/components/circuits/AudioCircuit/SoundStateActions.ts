...
import { SoundStateAction, Tone } from "@/modules/Type";

export const startOscillator = (
...
export const startOscillatorSome = (
  dispatch: Dispatch<SoundStateAction>,
  tones: Tone[]
) => {
...
export const stopOscillatorExcept = (
  dispatch: Dispatch<SoundStateAction>,
  tone: Tone
) => {
...
export const stopOscillatorExcepts = (
  dispatch: Dispatch<SoundStateAction>,
  tones: Tone[]
) => {
